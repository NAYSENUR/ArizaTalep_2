...
{
    public partial class Form3_Kullanici_SorunBildir : Form
    {
        public Form3_Kullanici_SorunBildir()
        {
            InitializeComponent();
        }
        ...
        private void Form3_Kullanici_SorunBildir_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Gonder_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@ts_tur_id", 1);
            ...
            XtraMessageBox.Show("Sorun Gönderildi..");
